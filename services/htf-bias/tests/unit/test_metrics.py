...
def test_update_htf_detail_metrics_all_fields():
    ...
    assert metrics.htf_bias_score.labels(mode="test", service="htf-bias")._value._value == 9.5
    assert metrics.htf_bias_confidence.labels(mode="test", service="htf-bias")._value._value == 4.0  # A+ = 4
    assert metrics.htf_dxy_aligned.labels(mode="test", service="htf-bias")._value._value == 1.0
    assert metrics.htf_chop_detected.labels(mode="test", service="htf-bias")._value._value == 0.0
    assert metrics.htf_conflict_detected.labels(mode="test", service="htf-bias")._value._value == 0.0
    assert metrics.htf_vwap_trend_confirmed.labels(mode="test", service="htf-bias")._value._value == 1.0
    assert metrics.htf_bos_detected.labels(mode="test", service="htf-bias")._value._value == 1.0
    assert metrics.htf_liquidity_sweep_detected.labels(mode="test", service="htf-bias")._value._value == 0.0
    assert metrics.htf_structure_15m.labels(mode="test", service="htf-bias")._value._value == 1.0  # HH = 1
    assert metrics.htf_structure_1h.labels(mode="test", service="htf-bias")._value._value == 1.0  # HH = 1
    assert metrics.htf_seasonality_adjustment.labels(mode="test", service="htf-bias")._value._value == 0.8
...
def test_update_htf_detail_metrics_confidence_encoding():
    ...
    for confidence, expected_value in test_cases:
        ...
        assert metrics.htf_bias_confidence.labels(mode="test", service="htf-bias")._value._value == expected_value
...
def test_update_htf_detail_metrics_structure_encoding():
    ...
    for structure, expected_value in test_cases:
        ...
        assert metrics.htf_structure_15m.labels(mode="test", service="htf-bias")._value._value == expected_value
...
def test_update_htf_detail_metrics_handles_missing_optional_fields():
    ...
    assert metrics.htf_conflict_detected.labels(mode="test", service="htf-bias")._value._value == 0.0
    assert metrics.htf_vwap_trend_confirmed.labels(mode="test", service="htf-bias")._value._value == 0.0
    assert metrics.htf_bos_detected.labels(mode="test", service="htf-bias")._value._value == 0.0
    assert metrics.htf_seasonality_adjustment.labels(mode="test", service="htf-bias")._value._value == 0.0
