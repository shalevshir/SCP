...
from scp_shared.indicators.vwap import calculate_vwap_deviation
...
def process_features(
    ...
    Example:
        ...
        >>> from scp_shared.indicators.integration import process_features
...
def process_features_with_validation(
    ...
    Example:
        >>> from scp_shared.indicators.backtesting import BacktestProcessor
