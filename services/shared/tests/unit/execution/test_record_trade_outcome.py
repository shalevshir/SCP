...
class TestRecordTradeOutcome:
    ...
    def test_trade_spanning_multiple_days_uses_close_date(self, base_trade: TradeRecord) -> None:
        ...
        trade_opened_day1 = TradeRecord(
            ...
            risk_amount=10.0,
            reward_amount=20.0,
            entry_timestamp=datetime(2024, 3, 15, 22, 0, tzinfo=timezone.utc),  # Day 1, late evening
            entry_bar_idx=100,
            reached_1r=False,
            exit_timestamp=datetime(2024, 3, 16, 2, 0, tzinfo=timezone.utc),  # Day 2, early morning
        )
        ...
        trade2_day2 = TradeRecord(
            ...
            risk_amount=10.0,
            reward_amount=20.0,
            entry_timestamp=datetime(2024, 3, 15, 20, 0, tzinfo=timezone.utc),  # Also opened Day 1
            entry_bar_idx=200,
            reached_1r=False,
            exit_timestamp=datetime(2024, 3, 16, 10, 0, tzinfo=timezone.utc),  # Closed Day 2
        )
        ...
        assert checker._daily_state["last_session_date"] == datetime(2024, 3, 16).date()
        assert checker._daily_state["consecutive_losses"] == 2  # Continued from previous loss
    ...
    def test_interleaved_trades_from_different_entry_dates(self) -> None:
        ...
        checker.record_trade_outcome(
            ...
            won=False,
            pnl_points=-50.0,
            close_timestamp=trade_a.exit_timestamp
        )
        assert checker._daily_state["last_session_date"] == datetime(2024, 3, 16).date()
        assert checker._daily_state["consecutive_losses"] == 1
        ...
        checker.record_trade_outcome(
            ...
            won=False,
            pnl_points=-30.0,
            close_timestamp=trade_b.exit_timestamp
        )
