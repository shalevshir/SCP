...
class TestVWAPHoldConfirmation:
    ...
    def test_single_bar_below_vwap_does_not_invalidate(self, base_trade):
        ...
        is_invalid, reason = checker.check_vwap_invalidation(base_trade, candle, features)
    ...
    def test_two_consecutive_bars_below_vwap_invalidates(self, base_trade):
        ...
        candle2 = make_candle(close=2643.0, timestamp=datetime(2025, 1, 15, 10, 2, tzinfo=timezone.utc))
        is_invalid, reason = checker.check_vwap_invalidation(base_trade, candle2, features)
    ...
    def test_counter_resets_on_non_invalidating_bar(self, base_trade):
        ...
        candle2 = make_candle(close=2646.0, timestamp=datetime(2025, 1, 15, 10, 2, tzinfo=timezone.utc))
        ...
        candle3 = make_candle(close=2644.0, timestamp=datetime(2025, 1, 15, 10, 3, tzinfo=timezone.utc))
    ...
    def test_short_trade_requires_consecutive_bars_above_vwap(self, base_trade):
        ...
        candle2 = make_candle(close=2647.0, timestamp=datetime(2025, 1, 15, 10, 2, tzinfo=timezone.utc))
        is_invalid, reason = checker.check_vwap_invalidation(base_trade, candle2, features)
    ...
    def test_configurable_n_bars_3_bars(self, base_trade):
        ...
        candle3 = make_candle(close=2642.0, timestamp=datetime(2025, 1, 15, 10, 3, tzinfo=timezone.utc))
        is_invalid, reason = checker.check_vwap_invalidation(base_trade, candle3, features)
