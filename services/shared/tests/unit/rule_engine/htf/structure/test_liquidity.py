...
import pandas as pd
import pytest
from scp_shared.rule_engine.htf.structure.liquidity import detect_liquidity_sweeps
...
class TestDetectLiquiditySweeps:
    ...
    def test_failed_sweep_high(self):
        ...
        assert sweep_events.iloc[3] == "sweep_high"
        assert sweep_success.iloc[3] is False  # Failed - next bar didn't break through
    ...
    def test_successful_sweep_high(self):
        ...
        assert sweep_events.iloc[3] == "sweep_high"
        assert sweep_success.iloc[3] is True  # Success - next bar broke through
    ...
    def test_failed_sweep_low(self):
        ...
        assert sweep_events.iloc[4] == "sweep_low"
        assert sweep_success.iloc[4] is False  # Failed - next bar didn't break down
    ...
    def test_successful_sweep_low(self):
        ...
        assert sweep_events.iloc[4] == "sweep_low"
        assert sweep_success.iloc[4] is True  # Success - next bar broke down
    ...
    def test_missing_high_column_raises(self):
        ...
        df = pd.DataFrame({"low": [98, 96, 93], "close": [99, 97, 94]})
    ...
    def test_missing_low_column_raises(self):
        ...
        df = pd.DataFrame({"high": [100, 105, 103], "close": [99, 104, 102]})
    ...
    def test_missing_close_column_raises(self):
        ...
        df = pd.DataFrame({"high": [100, 105, 103], "low": [98, 102, 100]})
    ...
    def test_invalid_swing_highs_type_raises(self):
        ...
        df = pd.DataFrame({"high": [100, 105], "low": [98, 102], "close": [99, 104]})
        ...
        df = pd.DataFrame(
            {
                ...
                "close": [
                    ...
                    103,
                    109,
                ],  # Index 3: BOS, Index 4: maybe sweep
            }
        )
