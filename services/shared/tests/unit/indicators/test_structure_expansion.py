...
class TestExpansionDetection:
    ...
    def test_no_expansion_during_compression(self):
        ...
        if expansion_detected:
            ...
            invalid_reasons = [r for r in reasons if r in ["recent_bos", "range_expansion", "displacement_candle"]]
            assert len(invalid_reasons) == 0, f"Should not detect {invalid_reasons} during compression"
