...
def test_session_valid_gauge_set_valid():
    ...
    assert (
        metrics.session_valid.labels(mode="test", service="bot-core")._value._value
        == 1.0
    )
...
def test_current_setup_type_vwap_reclaim():
    ...
    assert (
        metrics.current_setup_type.labels(mode="test", service="bot-core")._value._value
        == 1.0
    )
...
def test_signal_score_gauge():
    ...
    assert (
        metrics.signal_score.labels(mode="test", service="bot-core")._value._value
        == 9.2
    )
...
def test_last_signal_score_gauge():
    ...
    assert (
        metrics.last_signal_score.labels(mode="test", service="bot-core")._value._value
        == 8.5
    )
...
def test_enforcer_tier_gauge():
    ...
    assert (
        metrics.enforcer_tier.labels(mode="test", service="bot-core")._value._value
        == 3.0
    )
