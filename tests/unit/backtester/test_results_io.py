...
class TestSaveResults:
    ...
    def test_save_results_creates_parent_directories(self, sample_results, tmp_path):
        ...
        assert not filepath.parent.exists(), "Parent directory should not exist initially"
    ...
    def test_save_results_with_none_pnl_dollars(self, sample_trade, sample_execution, tmp_path):
    ...
    def test_save_results_with_multiple_trades(self, sample_trade, sample_execution, tmp_path):
...
class TestRoundTripSerialization:
    ...
    def test_round_trip_with_none_values(self, sample_trade, sample_execution, tmp_path):
