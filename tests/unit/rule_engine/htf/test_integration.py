...
class TestCreateHTFBiasFuncVectorized:
    ...
    def test_vectorized_approach_uses_precomputed_features(self, sample_multi_tf_data):
        ...
        """
        with patch(
            "rule_engine.htf.integration._precompute_htf_features"
        ) as mock_precompute:
    ...
    def test_vectorized_returns_neutral_when_features_not_available(
        self, sample_multi_tf_data
    ):
    ...
    def test_invalid_approach_raises_error(self, sample_multi_tf_data):
        ...
        assert (
            "streaming" in error_msg and "vectorized" in error_msg
        ) or "streaming or vectorized" in error_msg
