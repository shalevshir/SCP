...
class TestStreamingStructureLabelFix:
    ...
    def test_structure_labels_populated_with_clear_trend(self) -> None:
        ...
        bars = [
            ...
            # Swing high #1
            (
                pd.Timestamp("2025-01-01 13:00:00", tz="UTC"),
                2005.0,
                2010.0,
                2003.0,
                2008.0,
            ...
            (
                pd.Timestamp("2025-01-01 17:00:00", tz="UTC"),
                2006.0,
                2008.0,
                2003.0,
                2004.0,
            ),  # Low (higher than previous)
            (
                pd.Timestamp("2025-01-01 18:00:00", tz="UTC"),
                2004.0,
                2010.0,
                2003.0,
                2008.0,
            ...
            (
                pd.Timestamp("2025-01-01 19:00:00", tz="UTC"),
                2008.0,
                2015.0,
                2007.0,
                2012.0,
            ...
            (
                pd.Timestamp("2025-01-01 20:00:00", tz="UTC"),
                2012.0,
                2020.0,
                2011.0,
                2018.0,
            ...
            (
                pd.Timestamp("2025-01-01 21:00:00", tz="UTC"),
                2018.0,
                2019.0,
                2014.0,
                2015.0,
            ...
            (
                pd.Timestamp("2025-01-01 22:00:00", tz="UTC"),
                2015.0,
                2017.0,
                2013.0,
                2016.0,
            ...
            (
                pd.Timestamp("2025-01-01 23:00:00", tz="UTC"),
                2016.0,
                2018.0,
                2014.0,
                2017.0,
        ...
        assert final_label is not None and not pd.isna(
            final_label
        ), f"Expected final structure label to be set, got: {final_label}"

        # Should see bullish labels (HH or HL) in an uptrend
        bullish_labels = [
            label for _, label in structure_labels_found if label in ["HH", "HL"]
        ]
    ...
    def test_empty_structure_when_insufficient_data(self) -> None:
        ...
        for timestamp, open_price, high, low, close in bars:
            ...
            assert label is None or pd.isna(
                label
