...
class TestAlignDataframes:
    ...
    def test_aligns_by_timestamp_inner_join(self):
        ...
        gc_timestamps = pd.date_range("2024-07-01 10:00", periods=5, freq="1min", tz=UTC)
        gc_df = pd.DataFrame(
            {"open": [2650.0, 2651.0, 2652.0, 2653.0, 2654.0]},
            index=gc_timestamps,
        )
        ...
        dxy_timestamps = pd.date_range("2024-07-01 10:02", periods=5, freq="1min", tz=UTC)
        dxy_df = pd.DataFrame(
    ...
    def test_raises_error_on_gc_without_datetime_index_or_ts_event(self):
        ...
        dxy_timestamps = pd.date_range("2024-07-01 10:00", periods=2, freq="1min", tz=UTC)
    ...
    def test_raises_error_on_dxy_without_datetime_index_or_ts_event(self):
        ...
        gc_timestamps = pd.date_range("2024-07-01 10:00", periods=2, freq="1min", tz=UTC)
