...
def test_stub_returns_empty_list():
    ...
    dxy_candle = Candle(
        timestamp=datetime(2025, 1, 1, 12, 0, tzinfo=timezone.utc),
        open=105.0, high=105.5, low=104.8, close=105.2,
        volume=500.0,
        symbol="DXY",
        timeframe="5m",
        source="ICE"
...
def test_align_with_multiple_candles():
    ...
    gc_candles = [
        Candle(
            timestamp=datetime(2025, 1, 1, 12, 0, tzinfo=timezone.utc),
            open=2050.0, high=2055.0, low=2048.0, close=2052.0,
            volume=1000.0, symbol="GC", timeframe="5m", source="CME"
        ),
        Candle(
            timestamp=datetime(2025, 1, 1, 12, 5, tzinfo=timezone.utc),
            open=2052.0, high=2057.0, low=2050.0, close=2055.0,
            volume=1200.0, symbol="GC", timeframe="5m", source="CME"
        ),
    ]
    ...
    dxy_candles = [
        Candle(
            timestamp=datetime(2025, 1, 1, 12, 0, tzinfo=timezone.utc),
            open=105.0, high=105.5, low=104.8, close=105.2,
            volume=500.0, symbol="DXY", timeframe="5m", source="ICE"
        ),
        Candle(
            timestamp=datetime(2025, 1, 1, 12, 5, tzinfo=timezone.utc),
            open=105.2, high=105.7, low=105.0, close=105.5,
            volume=600.0, symbol="DXY", timeframe="5m", source="ICE"
        ),
    ]
