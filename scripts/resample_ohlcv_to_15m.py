"""Script to resample 1-minute OHLCV data to 15-minute bars.

This script reads 1-minute OHLCV CSV files and resamples them to 15-minute
...
RESAMPLE_FREQUENCY = "15min"  # Target frequency
...
def main(
    ...
    Args:
        ...
        frequency: Pandas frequency string for resampling (default: '15min')
