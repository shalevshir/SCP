"""Script to resample 1-minute OHLCV data to 1-hour bars.

This script reads 1-minute OHLCV CSV files and resamples them to 1-hour
...
Usage:
    python scripts/resample_ohlcv_to_1h.py
"""
...
RESAMPLE_FREQUENCY = "1H"  # Target frequency
...
def resample_ohlcv(
    ...
    Args:
        ...
        frequency: Pandas frequency string (e.g., '15min', '1H', '4H')
...
def main(
    ...
    Args:
        ...
        frequency: Pandas frequency string for resampling (default: '1H')
    ...
    try:
        ...
        logger.info("Starting OHLCV resampling script")
        ...
        for input_file in input_files:
            try:
                ...
                # Replace 'ohlcv-1m' with 'ohlcv-1h'
                output_filename = input_file.name.replace("ohlcv-1m", "ohlcv-1h")
