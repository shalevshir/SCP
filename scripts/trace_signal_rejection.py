...
def trace_pipeline_with_logging(data_dir: str, start_date: str, end_date: str, warmup_days: int = 2):
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        print("Usage: python trace_signal_rejection.py <data_dir> <start_date> <end_date> [warmup_days]")
        sys.exit(1)
