...
def extract_execution_dataframes(
    ...
    gc_data = {
        ...
        "volume": [
            bar.execution_1m[0].volume for bar in multi_tf_data.synchronized_bars
        ],
    }
    ...
    dxy_data = {
        ...
        "volume": [
            bar.execution_1m[1].volume for bar in multi_tf_data.synchronized_bars
        ],
    }
...
def candles_to_dataframe(
    ...
    logger.debug(
        f"Converted {len(candles)} candles to DataFrame (timeframe={timeframe})"
    )
